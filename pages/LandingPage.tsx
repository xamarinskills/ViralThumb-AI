        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-16">
            ...
            <button
              ...
              className="w-full sm:w-auto px-10 py-5 glass hover:bg-white/5 text-white font-black rounded-2xl transition-all hover:scale-105 flex items-center justify-center gap-2"
            >
              <span className="material-symbols-outlined transition-transform group-hover:scale-110">grid_view</span>
              Browse Templates
            </button>
          </div>
